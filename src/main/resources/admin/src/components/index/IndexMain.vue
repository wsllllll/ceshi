<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0 0 0 140px","margin":"0","position":"relative","background":"#fafafe","display":"block"} : {"minHeight":"100%","padding":"0","margin":"0 0 0 250px","position":"relative","background":"linear-gradient(170deg, rgba(255,255,255,1) 0%, rgba(204,231,255,1) 100%),#f4f7fe","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 2px 0px #055bab","padding":"0px 30px","margin":"0 auto","alignItems":"center","background":"none","display":"flex","width":"96%","position":"relative","justifyContent":"flex-end","zIndex":"1","height":"80px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"width":"calc(100% - 60px)","padding":"12px 10px","boxShadow":"0 2px 0px #055bab","margin":"0 auto","borderRadius":"0px","background":"none"}' class="bread-crumbs"></bread-crumbs>
