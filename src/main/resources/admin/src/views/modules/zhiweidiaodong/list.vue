			...
			<div :style='{"border":"1px solid #e9eafc","width":"100%","padding":" 0px 15px 20px","boxShadow":"none","borderRadius":"10px","background":"#fff"}'>
				<el-table class="tables"
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button class="view" v-if=" isAuth('zhiweidiaodong','查看')" type="success" @click="addOrUpdateHandler(scope.row.id,'info')">
								<span class="icon iconfont icon-chakan2" :style='{"margin":"0 0px","fontSize":"14px","color":"#333","display":"none","height":"40px"}'></span>
								详情
							</el-button>
							<el-button class="btn8" v-if="isAuth('zhiweidiaodong','申诉')&&scope.row.zhuangtai=='待完成'" @click="zhiweishensuCrossAddOrUpdateHandler(scope.row,'cross','','','[1]','你已申诉')" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 0px","fontSize":"14px","color":"#333","display":"none","height":"40px"}'></span>
								申诉
							</el-button>
							<el-button class="btn8" v-if="isAuth('zhiweidiaodong','同意')&&scope.row.zhuangtai=='待完成'" @click="tongyixinxiCrossAddOrUpdateHandler(scope.row,'cross','','','[1]','请勿重复操作!')" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 0px","fontSize":"14px","color":"#333","display":"none","height":"40px"}'></span>
								同意
							</el-button>
							<el-button class="edit" v-if=" isAuth('zhiweidiaodong','修改') " type="success" @click="addOrUpdateHandler(scope.row.id)">
							...
							<el-button class="del" v-if="isAuth('zhiweidiaodong','删除')" type="primary" @click="deleteHandler(scope.row.id)">
		...
		methods: {
			...
			getDataList() {
				...
				if(this.searchForm.xianzhiwei!='' && this.searchForm.xianzhiwei!=undefined){
					params['xianzhiwei'] = this.searchForm.xianzhiwei
				}
				if(this.searchForm.biandongyuanyin!='' && this.searchForm.biandongyuanyin!=undefined){
